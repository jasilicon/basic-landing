export const siteConfig = {
    ...
    copy: {
        ...
        testimonial: {
          quote: "Metric Master completely changed how we run our weekly pipeline reviews. We instantly knew where to focus our coaching efforts.",
          author: "Jame Doe",
